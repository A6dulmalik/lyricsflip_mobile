...
export default function WagerSinglePlayerMode() {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>Wager (Single Player)</Text>
            ...
            <View style={styles.statsContainer}>
                ...
                <View style={styles.statsItem}>
                    <Text style={styles.statsTitle}>Score Count:</Text>
                    <Text style={styles.statsValue}>5/5</Text>
                </View>
                <View style={styles.statsItem}>
